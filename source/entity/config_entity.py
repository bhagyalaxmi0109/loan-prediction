...
class PipelineConfig:
    def __init__(self, global_timestamp):
        ...
        # self.mongodb_url_key = "mongodb+srv://veenagabnave:a3KF0xQb4l5M3wwr@cluster0.otxvmcd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0&tlsCAFile=" + ca
        # print(os.environ[constant.MONGODB_KEY])
        self.database_name = constant.DATABASE_NAME
        self.train_collection_name = constant.TRAIN_DI_COLLECTION_NAME
        self.mandatory_col_list = constant.DI_MANDATORY_COL_LIST
        self.mandatory_col_data_type = constant.DI_MANDATORY_COL_DATA_TYPE

        # DATA VALIDATION
        self.imputation_values_file = constant.DV_IMPUTATION_VALUES_FILE_NAME
        self.outliers_params_file = constant.DV_OUTLIERS_PARAMS_FILE
